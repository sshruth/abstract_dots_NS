...
% 2017-09 modified by SS to ramp up 
...
%% Vector of coherences based on coherence_std flag
% Fill in the vector for 10s 
for f = 1 : length(patch_index)
    index = patch_index(f);
    vCohs = zeros(1,10*screen_struct.mon_refresh);
    if 
