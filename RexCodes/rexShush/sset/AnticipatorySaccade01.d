...
** Enforcing a minimum of 500 ms i.e 200 after targ off
*/

int weib_timer(double minn, double maxx, double alfa, double betha) {
    ...
    duration = round(drawnnum) + minn;
    
//    drawnnum1 = (double)((-1/alfa)*log(1-unival));
//    drawnnum = pow(drawnnum,(1/betha))*1000;
//    if (drawnnum > maxx){
//        drawnnum = maxx;
//    }
//    duration = minn + round(drawnnum);
    
    timer_set1(0,0,0,0,duration,0);
    printf("Wait duration: %f ms\n",duration);
    return 0;
}
...
***/
	...
	teye_fp_cd:
		...
		to fixeyewinpos
	teye_targ_wait:
		do timer_set1_shell(1000,200,500,100,0,0)
