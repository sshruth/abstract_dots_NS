...
//	}
    ...
    /* This is the main section to randomize target locations on each trial
    ...
    if (TOY_RAND(1000) < 500) {
        ...
        gl_vsd->display->object_array[VSD_OBJECT_T2]->vertex = TOY_RT_TO_X(0,gl_menu_infoS.rfr,i+90);;
        gl_vsd->display->object_array[VSD_OBJECT_T2]->wrt = TOY_RT_TO_Y(0,gl_menu_infoS.rfr,i+90);;
        
    } else { /* flip about the horizontal axis */
        gl_vsd->display->object_array[VSD_OBJECT_T1]->vertex = TOY_RT_TO_X(0,gl_menu_infoS.rfr,i+270);
        gl_vsd->display->object_array[VSD_OBJECT_T1]->wrt = TOY_RT_TO_Y(0,gl_menu_infoS.rfr,i+270);
        gl_vsd->display->object_array[VSD_OBJECT_T2]->vertex = TOY_RT_TO_X(0,gl_menu_infoS.rfr,i+180);
        gl_vsd->display->object_array[VSD_OBJECT_T2]->wrt = TOY_RT_TO_Y(0,gl_menu_infoS.rfr,i+180);
