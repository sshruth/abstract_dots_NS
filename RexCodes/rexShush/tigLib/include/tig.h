...
#define TIGBLOCK 65536	/* size of tig buffer block */
...
struct fntabl {
	FILE *fdfont;		/* Fildes to font file ( for open and read) */
...
extern int TIGconv(struct spaxis *, int);	/* convert data to a TIG point */
