 ...
 **    
 */
int drawTarg(long showFixEye, long showFixHand, long showTarg)
{
	int num_show=0, num_hide=0;
	int show_ind[NUM_OBJECTS], hide_ind[NUM_OBJECTS];
	int flags[3] = {showFixEye, showFixHand, showTarg};
	int i;
...
***/
	...
	teye_targ_cd:
	    ...
	    to teye_waittargoff on 0 = gl_reward_fixation	  
	...
	teye_waittargoff:
		...
		to teye_targoff on +MET % timer_check1
	teye_targoff: /* turn the FP off */
		do drawTarg(1,0)
		to teye_targoff_cd on MAT_WENT % drawTarg_done 
