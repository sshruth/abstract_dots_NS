...
VLIST state_vl[] = {
	...
	"stim_X",				&fstimX,	NP, NP, 0, ME_FLOAT,
	"stim_Y",				&fstimY,	NP, NP, 0, ME_FLOAT,
	"pattern_no",			&tiffImage,	NP, NP, 0, ME_DEC,
	NS,
};
...
begin	first:
	...
	posStm:
		do PvexStimLocation(&numObj, &objNum, &fstimX, &fstimY);
	...
	eyein:
		...
		to ldaStm
	ldaStm:
		do PvexSwitchStim(&numObj, &objNum, &objOn)
