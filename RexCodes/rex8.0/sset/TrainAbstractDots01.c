...
//static int gl_coh_list[] = {32, 64, 91, 128, 192, 256, 384, 512, 756};
...
**	those that typically need to be set once during a session 
**  and those that should be set each time through the state set
**
**  args:
