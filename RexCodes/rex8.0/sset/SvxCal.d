...
pick_targ_location()
{
	...
	fpx = (float)(thsGrid[curstm].x * range);
	fpy = (float)(thsGrid[curstm].y * range);
...
saveEye()
{
	posArray[numPos].fpx = (int)fpx;
	posArray[numPos].fpy = (int)fpy;
