...
static int gl_coh_list[] = {0, 40, 80, 120, 160, 240, 320, 480, 640, 800};
//static int gl_coh_list[] = {0, 40, 80, 160, 320, 640};
...
int nexttrl (long do_over, long min_block_size, long randomize_flag)
{
	 ...
	 ** converted into x,y coordinates for all of the screen objects.
	 */
    ...
    if (j < 334) {
        ...
        gl_vsd->display->object_array[VSD_OBJECT_AP]->x = TOY_RT_TO_X(0,gl_menu_infoS.rfr,i+240);
        gl_vsd->display->object_array[VSD_OBJECT_AP]->y = TOY_RT_TO_Y(0,gl_menu_infoS.rfr,i+240);

    } else if(j < 667){
        gl_vsd->display->object_array[VSD_OBJECT_T1]->vertex = TOY_RT_TO_X(0,gl_menu_infoS.rfr,i+90);
        gl_vsd->display->object_array[VSD_OBJECT_T1]->wrt = TOY_RT_TO_Y(0,gl_menu_infoS.rfr,i+90);
        gl_vsd->display->object_array[VSD_OBJECT_T2]->vertex = TOY_RT_TO_X(0,gl_menu_infoS.rfr,i+210);
        gl_vsd->display->object_array[VSD_OBJECT_T2]->wrt = TOY_RT_TO_Y(0,gl_menu_infoS.rfr,i+210);
        gl_vsd->display->object_array[VSD_OBJECT_AP]->x = TOY_RT_TO_X(0,gl_menu_infoS.rfr,i+330);
        gl_vsd->display->object_array[VSD_OBJECT_AP]->y = TOY_RT_TO_Y(0,gl_menu_infoS.rfr,i+330);
        
    } else {
        gl_vsd->display->object_array[VSD_OBJECT_T1]->vertex = TOY_RT_TO_X(0,gl_menu_infoS.rfr,i+180);
        gl_vsd->display->object_array[VSD_OBJECT_T1]->wrt = TOY_RT_TO_Y(0,gl_menu_infoS.rfr,i+180);
        gl_vsd->display->object_array[VSD_OBJECT_T2]->vertex = TOY_RT_TO_X(0,gl_menu_infoS.rfr,i+300);
        gl_vsd->display->object_array[VSD_OBJECT_T2]->wrt = TOY_RT_TO_Y(0,gl_menu_infoS.rfr,i+300);
        gl_vsd->display->object_array[VSD_OBJECT_AP]->x = TOY_RT_TO_X(0,gl_menu_infoS.rfr,i+60);
        gl_vsd->display->object_array[VSD_OBJECT_AP]->y = TOY_RT_TO_Y(0,gl_menu_infoS.rfr,i+60);
