...
#define WIND0 0
#define WIND1 1
#define PHOTO_RESET_BIT Dio_id(PCDIO_DIO, 2, 0x10)
#define PHOTO_CELL_INPUT 0x2000
#define PHOTO_TRIG 1
...
begin	first:
	...
	fpdcmd:
		do PvexDimFix()
		to fpdim on +PHOTO_TRIG & photoTrigger
	fpdim:
		code FPDIMCD
		to eyeout
	eyeout:
	...
	fpfcmd:
		...
		to fpoff on +PHOTO_TRIG & photoTrigger	/* wait for vex response */
	fpoff:
		code FPOFFCD
		time 1000
		to first
