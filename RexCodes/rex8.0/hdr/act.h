...
int PvexDrawEllipticalFlowField ( int *nObjects , int *objList , int *radList , float *widthList , float *heightList , int *nearList , int *farList , int *covList , int *sizeList );
...
int PvexDrawHalfSineGrating ( int *nObjects , int *objList , int *orList , float *spatFreqList , float *tempFreqList , int *cntrPhaseList , float *redList , float *greenList , float *blueList , int *sizList );
int PvexDrawSquareGrating ( int *nObjects , int *objList , int *orList , float *spatFreqList , float *tempFreqList , int *cntrPhaseList , float *redList , float *greenList , float *blueList , int *sizList );
int PvexDrawHalfSquareGrating ( int *nObjects , int *objList , int *orList , float *spatFreqList , float *tempFreqList , int *cntrPhaseList , float *redList , float *greenList , float *blueList , int *sizList );
